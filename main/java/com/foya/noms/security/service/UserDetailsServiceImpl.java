...
//			UserDTO user = personnelDao.selectLoginUserByAccount(userName,new Date());
			UserDTO user = personnelDao.selectLoginUserByEName(userName,new Date());
			if (user == null || !"E".equals(user.getPsnType())) {
