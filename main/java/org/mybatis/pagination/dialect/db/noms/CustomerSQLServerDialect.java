package org.mybatis.pagination.dialect.db.noms;
...
public class CustomerSQLServerDialect extends Dialect {
	

	public CustomerSQLServerDialect(MappedStatement mappedStatement,
	...
	protected String getLimitString(String sql, String offsetName, int offset,
		...
		setPageParameter(offsetName, offset+1, Integer.class);
