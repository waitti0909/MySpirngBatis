...
public class SiteBuildSingleWorkApplyFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "SiteBuildSingleWorkApply";
	final String applyNo = "201501-007JunitTest";
	...
	public void makeTestData() {
		...
		applyUser.setUsername("P14075188");
		applyUser.setChName("P14075188_Chname");
		applyUser.setDeptId("450400");
		applyUser.setDeptName("450400_Chname");
		applyUser.setPassword("1");

		taskUser[0] = new UserDTO();
		taskUser[0].setUsername("P14075225");
		taskUser[0].setChName("P14075225_Chname");
		taskUser[0].setDeptId("450400");
		taskUser[0].setDeptName("450400_Chname");
		...
		applyWebDto.setApplyDescription("建站作業申請, 事由  junit test");
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowReject2() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowCountersignAtTask2Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowCountersignAtTask2Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkApplyFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
