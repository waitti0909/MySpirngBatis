...
public class CM001ServiceTest extends GenericTest {
	...
	public void testSearchCompanyByVatName() {
		String[] type = {"Y","N"};
		List<TbComCompany> company = service.searchCompanyByVatName("12345678", "junitTest", type);
	...
	public void testSaveNewCompany(){	
		...
		service.saveNewCompany(company);
		company = service.getCompanyDetailByID("87654321");
		Assert.assertNotNull(company);
	...
	public void testGetCompanyDetailByID(){
		TbComCompany company = service.getCompanyDetailByID("12345678");
		Assert.assertNotNull(company);
	...
	public void testSaveUpdateCompany(){
		...
		company.setROOM("1");
		company.setMEMO("junitTest");
		service.saveUpdateCompany(company);
		company = service.getCompanyDetailByID("12345678");
		Assert.assertNotNull(company);
		Assert.assertEquals(company.getCO_VAT_NO(), "12345678");
