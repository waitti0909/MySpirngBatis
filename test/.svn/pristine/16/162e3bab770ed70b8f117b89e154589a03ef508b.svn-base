...
public class SiteBuildSingleWorkCompletionApplyFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "SiteBuildSingleWorkCompletionApply";
	final String applyNo = "201501-008JunitTest";
	...
	public void makeTestData() {
		...
		applyWebDto.setApplyDescription("工單完工申請, 事由  junit test");
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkCompletionApplyFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkCompletionApplyFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkCompletionApplyFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkCompletionApplyFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkCompletionApplyFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkCompletionApplyFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildSingleWorkCompletionApplyFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
