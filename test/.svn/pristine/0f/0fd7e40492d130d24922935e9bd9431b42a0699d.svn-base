...
public class SearchSiteOutsourcingApplyFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "SearchSiteOutsourcingApply";
	final String applyNo = "201411-003JunitTest";
	...
	public void makeTestData() {
		...
		applyWebDto
				.setApplyDescription("尋點委外派工申請事由"
						+ "  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由"
						+ "  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由 "
						+ " junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由"
						+ "  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由"
						+ "  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由"
						...
						+ "  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由"
						+ "  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由"
						+ "  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test"
						+ "尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test"
						+ "尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test"
						+ "尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test"
						+ "尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test尋點委外派工申請事由  junit test"
						+ "尋點委外派工申請事由  junit test");
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowRejectAtTask1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowRejectAtTask2() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowCountersignAtTask2Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowCountersignAtTask2Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Notify();
	...
	@Ignore
	@Test
	public void testSearchSiteOutsourcingApplyFlowAbortProcessAtTask1() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
	...
	public List<WorkflowWebDTO> getTaskWebDto(UserDTO executor) throws WorkflowException {
		...
		for (WorkflowTodoDTO todoDto : todoDtos) {
			...
			if (StringUtils.equals(applyNo, tmpApplyNo)
				...
				taskWebDto.setJsonData("{'isModify':'N','selectSign:one'}");
