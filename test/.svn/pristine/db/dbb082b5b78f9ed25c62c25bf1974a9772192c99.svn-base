...
public class TransferApplyForLogisticsFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "TransferApplyForLogistics";
	final String applyNo = "201412-001JunitTest";
	...
	public void makeTestData() {
		...
		applyUser.setUsername("P12084409");
		applyUser.setChName("P12084409_Chname");
		applyUser.setDeptId("420002");
		applyUser.setDeptName("420002_Chname");
		applyUser.setPassword("1");

		taskUser[0] = new UserDTO();
		taskUser[0].setUsername("P11114155");
		taskUser[0].setChName("P11114155_Chname");
		taskUser[0].setDeptId("420002");
		taskUser[0].setDeptName("420002_Chname");
		taskUser[0].setPassword("1");

		taskUser[1] = new UserDTO();
		taskUser[1].setUsername("P11104123");
		taskUser[1].setChName("P11104123_Chname");
		taskUser[1].setDeptId("420000");
		taskUser[1].setDeptName("420000_Chname");
		...
		applyWebDto.setApplyDescription("資材(後勤)申請, 事由  junit test");
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowReject2() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowCountersignAtTask2Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowCountersignAtTask2Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyForLogisticsFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
