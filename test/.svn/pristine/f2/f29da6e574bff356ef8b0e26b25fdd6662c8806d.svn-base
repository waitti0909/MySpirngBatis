...
//	@Test 
	public void charliewoo() {
		...
		mailTo.add("yichuantsai@tstartel.com");
		String subject ="TSTAR MAIL TEST";
		String content ="這是由TSTAR MAIL SERVER發出來的測試信件，測試另一個發信的帳號(NOMS_RPT)，謝謝";
		List<String> ccTo = new ArrayList<String>();
		ccTo.add("yichuantsai@tstartel.com");
