package com.foya.noms.workflow.material;
...
public class TransferApplyFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "TransferApply";
	final String applyNo = "201412-002JunitTest";
	UserDTO applyUser = new UserDTO();
	UserDTO[] taskUser = new UserDTO[4];
	...
	public void makeTestData() {
		...
		applyUser.setChName("P02042291_Chname");
		applyUser.setDeptId("440400");
		applyUser.setDeptName("440400_Chname");
		applyUser.setPassword("1");

		taskUser[0] = new UserDTO();
		taskUser[0].setUsername("P05042726");
		taskUser[0].setChName("P05042726_Chname");
		...
		taskUser[1].setDeptId("440000");
		taskUser[1].setDeptName("440000_Chname");
		taskUser[1].setPassword("1");

		taskUser[2] = new UserDTO();
		taskUser[2].setUsername("P11114155");
		taskUser[2].setChName("P11114155_Chname");
		...
		taskUser[3].setChName("P11104123_Chname");
		taskUser[3].setDeptId("420000");
		taskUser[3].setDeptName("420000_Chname");
		...
		applyWebDto.setApplyDescription("資材申請, 事由  junit test");
	...
	@Ignore
	@Test
	public void testTransferApplyFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowReject2() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowReject3() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowReject4() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask2Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask2Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask3Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask3Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask4Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowCountersignAtTask4Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testTransferApplyFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testTransferApplyFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
