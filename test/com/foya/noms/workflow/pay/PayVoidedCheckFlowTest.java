...
public class PayVoidedCheckFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "PayVoidedCheck";
	final String applyNo = "201503-006JunitTest";
	List<WorkflowWebDTO> applyWorkflowWebDtos;
	UserDTO applyUser = new UserDTO();
	UserDTO[] taskUser = new UserDTO[6];
	...
	public void makeTestData() {
		...
		taskUser[2].setUsername("P12084409");
		taskUser[2].setChName("P12084409_Chname");
		...
		taskUser[5].setUsername("PTS000068");
		taskUser[5].setChName("PTS000068_Chname");
		taskUser[5].setDeptId("400000");
		taskUser[5].setDeptName("400000_Chname");
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowReject2() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowReject3() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowReject4() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowReject5() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowReject6() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask2Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask2Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask3Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask3Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask4Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask4Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask5Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask5Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask6Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowCountersignAtTask6Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testPayVoidedCheckFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
