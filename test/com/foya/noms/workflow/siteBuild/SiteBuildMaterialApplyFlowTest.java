...
public class SiteBuildMaterialApplyFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "SiteBuildMaterialApply";
	final String applyNo = "201501-005JunitTest";
	...
	public void makeTestData() {
		...
		applyUser.setUsername("P05093191");
		applyUser.setChName("P05093191_Chname");
		applyUser.setDeptId("440100");
		applyUser.setDeptName("440100_Chname");
		applyUser.setPassword("1");

		// 申請單位-部主管
		taskUser[0] = new UserDTO();
		taskUser[0].setUsername("P11104099");
		taskUser[0].setChName("P11104099_Chname");
		taskUser[0].setDeptId("440100");
		taskUser[0].setDeptName("440100_Chname");
		...
		applyWebDto.setApplyDescription("領料申請, 事由  junit test");
	...
	@Ignore
	@Test
	public void testSiteBuildMaterialApplyFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSiteBuildMaterialApplyFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testSiteBuildMaterialApplyFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildMaterialApplyFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildMaterialApplyFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildMaterialApplyFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildMaterialApplyFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
