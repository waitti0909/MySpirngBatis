...
public class SiteBuildOutsourcingApplyFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "SiteBuildOutsourcingApply";
	...
	public void makeTestData() {
		...
		applyWebDto.setApplyDescription("委外派工申請, 事由  junit test");
	...
	@Ignore
	@Test
	public void testSiteBuildOutsourcingApplyFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testSiteBuildOutsourcingApplyFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testSiteBuildOutsourcingApplyFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildOutsourcingApplyFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildOutsourcingApplyFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildOutsourcingApplyFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testSiteBuildOutsourcingApplyFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
