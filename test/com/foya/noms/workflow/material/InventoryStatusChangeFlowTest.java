...
public class InventoryStatusChangeFlowTest extends GenericTest {
	@Autowired
	...
	final String processType = "InventoryStatusChange";
	final String applyNo = "201412-003JunitTest";
	...
	public void makeTestData() {
		...
		applyWebDto.setApplyDescription("物料狀態異動申請, 事由  junit test");
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowApproval() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowReject1() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Reject();
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowReject2() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowCountersign() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowCountersignAtTask1Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowCountersignAtTask1Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowCountersignAtTask2Countersign1Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowCountersignAtTask2Countersign2Reject() {
		try {
			testApply();
			Thread.sleep(1500);
			testTask1Approval();
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowNotify() {
		try {
			testApply();
			Thread.sleep(1500);
	...
	@Ignore
	@Test
	public void testInventoryStatusChangeFlowAbortProcess() {
		try {
			testApply();
			Thread.sleep(1500);
			abortProcess();
