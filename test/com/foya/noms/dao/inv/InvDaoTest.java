...
public class InvDaoTest extends GenericTest {
	...
	public void testInsertInvOnHand() {
		int status = invDao.insertInvOnHand("T001", 3, "T201420141", "2014121200061", "M001", 1, 2,
				"F001", 2, "inv1");
		Assert.assertTrue(status == 1);
	}
	...
	public void testInsertInvToErpMat() {
		int status = invDao.insertInvToErpMat("T201420141", "2014112500071", "OS001", "PO001", 2,
				"M001", "V001", "F001", 2, "RCV001", "inv1", "inv1", new Date());
		Assert.assertTrue(status == 1);
	}
	...
	public void testUpdateInvAsset_Unload() {
		int status = invDao.updateInvAsset_Unload("201411270014", "M", "M001", 2, new Date(),
				"A001", "inv1", 123);
		Assert.assertTrue(status == 1);
	}
	...
	public void testUpdateInvAsset_Setup() {
		int status = invDao.updateInvAsset_Setup("L001", 123, "F001", 10, "201411270014", "M",
				"M001", new Date(), "A001", 3, "inv1", "inv1");
		Assert.assertTrue(status == 1);
	}

	@Test
	public void testUpdateInvAsset_Complete() {
		int status = invDao.updateInvAsset_Complete("201411270014", "M", "M001", 2, new Date(),
				new Date(), "inv1");
		Assert.assertTrue(status == 1);
	}
	...
	public void testUpdateInvSiteTxn_ToErpDate() {
		int status = invDao.updateInvSiteTxn_ToErpDate("T201420141", "2014112500071", 1, "inv1");
		Assert.assertTrue(status == 1);
	}
