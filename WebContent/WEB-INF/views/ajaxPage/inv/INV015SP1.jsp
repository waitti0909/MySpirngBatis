		...
		<div class="col-xs-12 col-sm-12">
			<div class=" ui-draggable ui-droppable">
				<div class="box-header">
					<div class="box-name">
						<i class="fa fa-edit"></i> <span>收料單簽收單</span>
					</div>
					<div class="box-icons">
				...
				<div class="box-content">
					...
					<table style="width: 100%" align="center">
						<div class="form-group">
							<div class="row">
								<tr>
									<td><label class="col-sm-12 control-label">收料單號：</label></td>
						...
						<tr>
							<td><label class="col-sm-12 control-label">收料倉庫：</label></td>
							<td>
					...
					<table style="width: 70%;height: 100px" align="center" cellpadding="5" cellspacing="5" frame="border" rules="all">
						<tr>
							<td style="height: 15px" align="center">退料人員簽章</td><td style="height: 15px" align="center">退料倉管簽章</td>
						</tr>
						<tr>
							<td></td>
							<td></td>
