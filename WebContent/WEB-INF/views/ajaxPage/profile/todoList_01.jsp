...
$(document).ready(function() {
	...
	var table = $('#ownDatatable').dataTable( {
		"aaSorting" : [[ 1, "desc" ]],
		"sDom" : "rtS",
		"iDisplayLength" : -1,
		"sScrollY" : 300,
        ...
        "bProcessing" : false,
        "sAjaxDataProp" : "rows",
        "sAjaxSource" : CONTEXT_URL+'/profile/todoList/own/data',
	...
	$('#ownDatatable tbody').on( 'click','a', function () {
		...
		<div class="col-xs-12">
			<div class="box-content no-padding">
				<table
					...
					id="ownDatatable" width="100%">
					<thead>
						<tr>
							<td><input type="checkbox" id="selectAll"/>簽核</td>
